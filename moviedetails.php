...
//	$review_result_row = $review_result->fetch_assoc();
	...
	<div class="row">
		...
		<div class="col-xs-8">
			...
			<?php if (empty($login)) { ?>
					<p class="lead"><a href="loginform.php">Sign in</a> or <a href="registration.php">register</a> to leave a review or make this a favorite marvel movie!</p>
			<?php	} else { ?>
				<p>
					...
					<?php if ($role == 1) : ?>
						<a class="btn btn-danger" href="deletemovie.php?id=<?php echo $result_row['movie_id']; ?>">DELETE MARVEL MOVIE <i class="fa fa-close"></i></a>
				<?php
				endif;?>
			<?php } ?>
		</div>
