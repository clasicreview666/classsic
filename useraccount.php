	...
	<div class="container wrapper">
		...
		<div class="row">
			<div class="col-xs-8 col-xs-offset-2">
				...
				<p class="lead">Welcome to your user dashboard! Here you can edit your personal information, see favourite marvel movies, and your own reviews!</p>
			</div>
		</div>
		<div class="row">
			<div class="col-xs-8 col-xs-offset-2">
		...
		<div class="row">
			<div class="col-xs-6">
				<h2 class="text-center text-success">Your Favourite Marvel Movies</h2>
				<?php
				if (isset($items)) {
					...
					echo "<p class='lead text-center'>You don't have any favourite movies!</p>";
				}
				?>
			</div>
			<div class="col-xs-6">
