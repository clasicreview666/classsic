...
if (!$result) {
	...
	<div class="container wrapper">
		...
		<ul class="breadcrumb">
			...
			<li class="active">Search Movie Results</li>
		</ul>
		
	    <h1 class="text-center">Search Movie Results</h1>
	    
	    <div class="row">
			<div class="col-xs-4 col-xs-offset-8">
				<form action="<?=$_SERVER['PHP_SELF']?>" class="form-inline search-form" method="get" role="form">
					<div class="input-group">
						<label class="sr-only" for="movieSearch">Search Marvel Movies</label>
						<div class="input-group-addon"><i class="fa fa-search fa-lg"></i></div>
						<input type="text" name="movie" placeholder="Search Marvel Movie" id="movieSearch" class="form-control"/>
					</div>
