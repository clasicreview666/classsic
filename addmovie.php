...
?>
  ...
  <ul class="breadcrumb">
    ...
    <li class="active">Add Marvel Movie</li>
  </ul>

  <h1 class="text-center">ADD MARVEL MOVIE</h1>
  <p class="lead text-center">Please add your desired marvel movie</p>
  <div class="col-xs-8 col-xs-offset-2">
    <form class="form-horizontal" role="form" action="processmovie.php" method="get" enctype="text/plain">
      <div class="form-group">
        <label for="newMovieName" class="col-sm-3 control-label">Movie Name</label>
        <div class="col-sm-9">
          <input type="text" class="form-control" id="newMovieName" name="movie_name" placeholder="Movie Title" required>
        </div>
      </div>
      <div class="form-group">
        <label for="movieYear" class="col-sm-3 control-label">Released On</label>
        <div class="col-sm-9">
      ...
      <div class="form-group">
        <label for="movieRating" class="col-sm-3 control-label">Movie Rating</label>
        <div class="col-sm-9">
      ...
      <div class="form-group">
        <div class="col-sm-offset-3 col-sm-9">
          <button type="submit" class="btn btn-success">Add Marvel Movie</button>
        </div>
      </div>
    </form>
  </div>
